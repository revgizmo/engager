...
- **CI Pending / Blocked**: While CI is blocked (Issue #406), self-merge is allowed if `scripts/pre-pr-validation.R` and `scripts/save-context.sh` both complete successfully locally and results are recorded in the PR.
