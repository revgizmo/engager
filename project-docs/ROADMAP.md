...
package content may merge to it until the acceptance reconciliation, tag,
GitHub release, and issue #4 closeout described in the 0.1.1 release plan are
approved. CRAN remediation branches from `main`; applicable fixes are
forward-ported to `develop` through separate reviewed PRs.
