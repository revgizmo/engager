...
cat("Processed transcript column lengths:\n")
for (col in names(processed_transcript)) {
  cat(col, ":", length(processed_transcript[[col]]), "\n")
}
cat("Column names:", paste(names(processed_transcript), collapse = ", "), "\n")
cat("Dimensions:", paste(dim(processed_transcript), collapse = " x "), "\n")
## What the Package Does

cat("Summary metrics column lengths:\n")
for (col in names(summary_metrics)) {
  cat(col, ":", length(summary_metrics[[col]]), "\n")
}
cat("Column names:", paste(names(summary_metrics), collapse = ", "), "\n")
cat("Dimensions:", paste(dim(summary_metrics), collapse = " x "), "\n")
...
- **For transcript processing**: see `vignette("transcript-processing")`
- **For roster management**: see `vignette("roster-cleaning")`  
- **For visualization**: see `vignette("plotting")`
- **For advanced workflows**: see `vignette("session-mapping")`
- **For name matching help**: see `vignette("name-matching-troubleshooting")`
- **For FERPA compliance**: see `vignette("ferpa-ethics")`
