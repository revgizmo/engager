...
transcripts_metrics_df <- tibble::tibble(
  ...
  # Canonical percentage columns (preferred)
  perc_n = c(18.6, 27.9, 11.6, 34.9, 7.0),
  perc_duration = c(19.2, 28.8, 9.8, 38.0, 5.3),
  perc_wordcount = c(19.2, 28.8, 10.4, 35.2, 6.4),
...
plot_users(transcripts_metrics_df, metric = "perc_n", mask_by = "name")

# Plot percentage of speaking time
plot_users(transcripts_metrics_df, metric = "perc_duration", mask_by = "name")

# Plot percentage of words
plot_users(transcripts_metrics_df, metric = "perc_wordcount", mask_by = "name")
```
