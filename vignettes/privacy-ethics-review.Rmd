...
`anonymize_educational_data()` applies masking, hashing, or pseudonymization
transformations to recognized columns. Hashing requires an explicit non-empty
salt. Missing and blank identifiers remain missing or blank. These technical
operations do not by themselves establish that re-identification is impossible
or that an output satisfies a legal or institutional definition of anonymized
data.
...
Aggregation is intentionally not exposed through this helper in v0.1.0. Remove
row-level identifiers before aggregating and review the result before sharing it.
